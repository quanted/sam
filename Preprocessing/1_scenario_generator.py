...
class Scenario(object):
    ...
    def erosion(self):
        ...
        from Preprocessing.parameters import types
    ...
    def hydrology(self):
        ...
        from Preprocessing.parameters import delta_x, increments_1, increments_2
    ...
    def process_soil(self):
        from Preprocessing.parameters import delta_x, increments_1, increments_2, slope_range, uslep_values
